...
BGSPEED = 1.5
BGIMG = pygame.image.load('D:\Python car racing\Picture\Track\Background.png')
...
CARHEIGHT = 60
CARSPEED = 3
CARIMG = pygame.image.load('D:\Python car racing\Picture\Car\car.png')
...
OBSTACLESSSPEED = 2
CHANGESPEED = 0.01
OBSTACLESIMG = pygame.image.load('D:\Python car racing\Picture\obstacles\obstacles.png')
